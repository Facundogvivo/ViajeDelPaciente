...
function piso1AMuestras(){
    ...
    pisoEstablecimiento.src ="assets/img/img/nivel 1C.png";
...
function mensaje1() {
    ...
    document.getElementById('titulo1').innerHTML = "Debe dirigirse a la <font color='red'><em><b>Sala de espera de la Unidad de toma de muestras de la Torre A</b></em></font>"
...
const sonido1 = cargarSonido1("assets/audio/nivel 1C.mp3");
    sonido1.play();
}
...
function SE1TAM() {
    ...
    const lineas = [
        { x1: 40, y1: 100, x2: 40, y2: 83 },
        { x1: 40, y1: 83, x2: 55, y2: 83 },
        { x1: 55, y1: 83, x2: 85, y2: 69 },
        { x1: 85, y1: 69, x2: 150, y2: 69 },
        { x1: 150, y1: 69, x2: 150, y2: 83 },
        { x1: 150, y1: 83, x2: 210, y2: 83 }
    ]
